...
K1, D1, K2, D2, R, T = calib_yaml.get_all_calibration(scale_factor)


# Read images
img_1 = cv2.imread("/content/left.png")
img_2 = cv2.imread("/content/right.png")
